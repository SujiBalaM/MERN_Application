...
const DetailsSection = () => {
    ...
    return(
      ...
      <label className="text-gray-700 font-bold text-sm flex-1">
        Description
        <textarea
rows={10}          className="border rounded w-full py-1 px-2 font-normal"
      ...
      <label className="text-gray-700 font-bold text-sm max-w-[50%]">
        ...
        <select {...register("starRating",{required:"This Field is required"})} className="py-1 px-2 border rounded w-full text-gray-700 font-normal">

...
const SearchBar = () => {
  ...
  return (<form onSubmit={handleEvent} className="-mt-8 p-3 bg-orange-400 rounded shadow-md grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5 items-center gap-4">
    ...
    <div>
        <DatePicker selected={checkIn}
         ...
         className="min-w-full bg-white focus:outline-none p-2"
    ...
    <div className="flex gap-1">
        <button className="bg-blue-600 w-2/3 rounded h-full p-2 text-white font-bold text-xl hover:bg-blue-500">
            Search
        </button>
        <button className="bg-red-600 w-1/3 rounded h-full p-2 text-white font-bold text-xl hover:bg-red-500">
            Clear
        </button>
